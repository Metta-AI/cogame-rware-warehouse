...
# Substitute: rware-warehouse, coworld-rware-warehouse, 4.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-rware-warehouse:ci)
#   SMOKE_SLUG                 game slug                        (rware-warehouse)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/rware-warehouse)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/rware-warehouse-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-rware-warehouse:ci}}"
slug="${SMOKE_SLUG:-rware-warehouse}"
